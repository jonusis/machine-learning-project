...
function YuliaoBox() {
    useEffect(()=>{
        var url = 'http://101.37.163.122:5000/api/v1/lib?page=' + 1;
        fetch(url,{
            mode:'cors',
            method: 'GET',
        }).then((res)=>{
    ...
    function getData(pgNum){
        var url = 'http://101.37.163.122:5000/api/v1/lib?page=' + pgNum;
        fetch(url,{
            mode:'cors',
            method: 'GET',
        }).then((res)=>{
    ...
    return(
        ...
        <div className="msgTitle">不良语言语料库</div>
